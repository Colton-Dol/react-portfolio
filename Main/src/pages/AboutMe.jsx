...
function AboutMe() {
    return ( 
        <div className="ms-5 mt-5">
            ...
            <br />
            <img src='./src/assets/images/profile-picture.jpg' className="profpic rounded-circle ms-4" style={{width: 175}} alt="picture of a man with red hair wearing a green shirt, bucket hat, and glasses smiling at the camera" />
            <br />
